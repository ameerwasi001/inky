...
//anything! 
    ...
    var $functions = $(`<nav class="nav-group">
        <div class="nav-text" style="display: flex; justify-content: space-between">
            <h5 class="nav-group-title">Functions</h5>
            <div class="alphabetical-sort">a-z</div>
        </div>
    </nav>`);
    var $externals = $(`<nav class="nav-group">
        <div class="nav-text" style="display: flex; justify-content: space-between">
            <h5 class="nav-group-title">Externals</h5>
            <div class="alphabetical-sort">a-z</div>
        </div>
    </nav>`);
        ...
        if (symbol.innerSymbols){
            ...
            Object.keys(symbol.innerSymbols).forEach((innerSymbolName) => {
                ...
                if (innerSymbol.flowType.name == "Stitch"){
                    ...
                    items.push(`<span class="nav-group-item ${extraClass}" row = "${innerSymbol.row}">
...
function setFiles(mainInk, allFiles) {
    ...
    groupsArray.forEach(group => {
        ...
        var $group = $(`<nav class="nav-group ${extraClass}"><div style="display: flex; justify-content: space-between">
                <h5 class="nav-group-title">Content</h5>
                <div>a-z</div>
            </div> ${items} </nav>`);
